...
urlpatterns = [
    ...
    path('create/', views.add_users, name='add-user'),
    path('all/', views.view_users, name='view-user'),
    path('update/<int:pk>/', views.update_users, name='update-user'),
    path('<int:pk>/delete/', views.delete_users, name='delete-user'),
